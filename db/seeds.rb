...
AdminUser.create!(email: 'julio1741@gmail.com', password: '12345678', password_confirmation: '12345678') if Rails.env.development?
AdminUser.create!(email: 'roqueheliarenas@gmail.com', password: '12345678', password_confirmation: '12345678') if Rails.env.development?